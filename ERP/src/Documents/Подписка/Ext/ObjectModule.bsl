...
Функция ДатаСледующейОплаты() Экспорт
	...
	Запрос.Текст = 
		"ВЫБРАТЬ ПЕРВЫЕ 1
		|	ПланВыставленияСчетовНаПродлениеПодписки.ДатаФормированияСчета КАК ДатаФормированияСчета
		|ИЗ
	...
	Возврат ВыборкаДетальныеЗаписи.ДатаФормированияСчета;
