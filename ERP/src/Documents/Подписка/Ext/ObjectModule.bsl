Процедура ОбработкаПроведения(Отказ, Режим)
	...
	// регистр ИспользованияПромокода
	Движения.ИспользованияПромокода.Записывать = Истина;
	Движение = Движения.ИспользованияПромокода.Добавить();
	Движение.Период = Дата;
	Движение.Промокод = Промокод;
	Движение.Пользователь = Клиент;

	// регистр ПодпискиПериодДействия
	Движения.ПодпискиПериодДействия.Записывать = Истина;
	Движение = Движения.ПодпискиПериодДействия.Добавить();
	Движение.Подписка = Ссылка;
	Движение.ДатаНачала = ДатаНачала;
	Движение.ДатаОкончания = ОбщегоНазначения.ДатаОкончанияВремен();
...
Функция Активировать() Экспорт
	
	Статус = Перечисления.СтатусПодписки.Активна;
