...
Функция ЗапросHTTP(Домен, Порт, Относительный_URL, Метод, Заголовки, ПараметрыЗапроса=Неопределено, TLS=Ложь, ТаймаутСекунды=30) Экспорт
	...
	Попытка
		...
		Соединение = Новый HTTPСоединение(
	        Домен, Число(Порт),,,,ТаймаутСекунды,
