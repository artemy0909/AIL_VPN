...
Процедура ПроверитьДоступностьФормирования()
	...
	Если Инструменты.ДатаЗаполнена(Объект.ДатаПодписки) И ЗначениеЗаполнено(Объект.Клиент) И ЗначениеЗаполнено(Объект.ВыбранныйТариф) Тогда
...
Процедура УстановитьПрайсЛистПоПромокоду()
	...
	Если НЕ Инструменты.ДатаЗаполнена(Объект.ДатаПодписки) Тогда
